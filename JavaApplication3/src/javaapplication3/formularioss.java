 ...
 * @author LUIS
 */
public class formularioss extends javax.swing.JFrame {

    /**
     * Creates new form formularioss
     */
    public formularioss() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formularioss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formularioss().setVisible(true);
            }
        });
    }
